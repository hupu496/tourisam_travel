                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <p class="mb-5 fs-5">HolyLand Pilgrimage Tours (OPC) offers spiritually enriching
                                    journeys through sacred sites across Israel and the Holy Land. Each tour is
                                    carefully designed to deepen faith, foster reflection, and connect travelers to
                                    biblical history.
                                </p>
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7"
                    ...
                    <h1 class="mb-4">Welcome to <span class="text-primary">Holy Land Pilgrimage Tours (OPC)</span></h1>
                    <p class="mb-4">Initiative by Shri Ranjit Toppo, specializes in organizing pilgrimage tours to
                        the Holy Land and Europe, focusing on significant Christian pilgrimage sites! </p>
                    <p class="mb-4">Committed to providing enriching spiritual experiences, the company aims to expand
                        its offerings to other countries and also include leisure trips, catering to a broader audience
                        seeking both religious and recreational travel experiences.</p>
    ...
    <div class="container-fluid ExploreTour py-5">
        <div class="container py-5">
            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                ...
                <p class="mb-0">Explore a travel tour with Holy Land Pilgrimage Tours and experience a deeply spiritual
                    journey through the sacred sites of the Holy Land, thoughtfully designed to inspire faith and
                    reflection.
                </p>
            </div>
            <div class="tab-class text-center">
                <ul class="nav nav-pills d-inline-flex justify-content-center mb-5">
                    ...
                    <li class="nav-item">
                        <a class="d-flex py-2 mx-3 border border-primary bg-light rounded-pill active"
                            ...
                            <span class="text-dark" style="width: 250px;">Upcoming tour Category</span>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
