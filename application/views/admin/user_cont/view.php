                        ...
                        <?php
                        	...
                        	<tr>
                                ...
                                <td>
                                     ...
                                     <a  href='<?php echo base_url("admin/user_cont/userdelete/$slist[id]") ;?>' class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i> Delete </a>
                                </td>
                            </tr>
                            <?php
                                    }
...
<div id="myModal" class="modal">
    ...
    <!-- Full-size image -->
    <img class="modal-content" id="fullImage" src="<?php echo $slist['photo']; ?>" alt="Full Image">
</div>
...
<script>
    ...
    // Get the image thumbnail and modal image element
    ...
    // When the thumbnail is clicked, open the modal
