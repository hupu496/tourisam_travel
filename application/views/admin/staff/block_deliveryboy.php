        	...
        	<div class="box">
                ...
                <div class="box-body">
                	<table class="table data-table stripe hover nowrap">
                        ...
                        <tbody>
                        <?php
							if(is_array($block_deliveryboy)){ $i=0;
								foreach($block_deliveryboy as $slist){ $i++;                    
                            ?>
                        	<tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo base_url('admin/staff/unblock_deliveryboy/'.$slist['id']);?>" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i>unblock </a>
                                </td>
                            </tr>
                            <?php
                                    }
