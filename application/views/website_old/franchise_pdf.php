...
<head>
    ...
    <title>Franchise Book Confirmation<?php echo $order['id']; ?></title>
    <style >
        body {
...
<body>
   <div class="container"  id="invoice" style="width:100%;">
        ...
        <div class="order-details">
            ...
            <div class="detail-row">
                <span class="detail-label">Validate Upto 1 Year:</span>
                <span><?php echo date('d M Y', strtotime($order['expiry_date'])); ?></span>
            </div>
            <div class="detail-row">
        ...
        <div class="customer-details">
            ...
            <div class="detail-row">
                ...
                <span><?php echo $order['password']; ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Login Link:</span>
                <span><?php echo base_url('/user'); ?></span>
            </div>
           
            <div class="detail-row">
                <span class="detail-label">Franchise Booking Status:</span>
                ...
                <?php } elseif($order['order_status'] == 0){ ?>
                 ...
                 <?php } elseif($order['order_status'] == 3){ ?>
                    <button class="btn btn-sm" style="background-color:red; color:white;">Wrong UTR No</button>
                <?php } ?>
            </div>
            <span style="color: red;">NOTE:Within 48 hrs Booking Confirm and you can login.</span>
        </div>
        <div class="barcode">
            <h2>Booking Barcode</h2>
